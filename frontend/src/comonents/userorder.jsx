...
function Userorder() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const res = await axios.get("https://backend-api-cl99.onrender.com/api/order");
        setitem(res.data);
      } catch (err) {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {item.map((index) => (
              ...
              >
                {/* Product Image */}
                <img
                  src={`https://backend-api-cl99.onrender.com/uploads/${index.img}`}
                  alt="order"
                ...
                <div className="text-gray-800">
                  ...
                  <p>
                    <span className="font-semibold">Email:</span> {index.email}
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="font-semibold">Phone:</span> {index.phone}
                  </p>
